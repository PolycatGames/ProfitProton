...
<body>
    ...
    <main class="main-content">
        <article>
            <section>
                <h1 class="category-title title">Content Creation</h1>
            </section>
            <section class="articles-3x category">
                <div class="articles-layout-3x-grid">
                    ...
                    $pattern = '/(\d+)\s+\{\s*title:\s*"([^"]*)"\s*preview:\s*"([^"]*)"\s*description:\s*"([^"]*)"\s*keywords:\s*"([^"]*)"\s*time:\s*"([^"]*)"\s*date:\s*"([^"]*)"\s*category:\s*"Content Creation"/';
