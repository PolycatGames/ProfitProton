...
<head>
    ...
    <!--Meta Data-->
    <title>AI | ProfitProton</title>
    <meta name="description" content="Learn how to make money with artificial intelligence, start your side hustle today!" />
    <meta name="keywords" content="AI" />
    <meta name="author" content="ProfitProton" />
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://profitproton.com/category/ai">
...
<body>
    ...
    <main class="main-content">
        <article>
            <section>
                <h1 class="category-title title">Artificial Intelligence</h1>
            </section>
