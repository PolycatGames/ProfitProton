<div class="pcr">
            ...
            <?php if ($showarticle[$i] !== 1) : ?>
                <a href="<?= $dataArray[$i]['link']; ?>">
                    <div class="pcr-article-latest" aria-label="Link to <?= $dataArray[$i]['title']; ?>">
                        <img src="<?= $dataArray[$i]['thumbnail']; ?>-400x.webp" alt="<?= $dataArray[$i]['title']; ?>" loading="lazy" decoding="async">
    ...
    <span class="pcr-disclosure pcr-holder">
        Disclosure: This article may contain affiliate links, which means we may earn a small commission if a reader clicks through and makes a purchase.
    </span>

    <a class="pcr-promo" rel="noopener nofollow sponsored" target="_blank" href="/fiverr">
        <div class="promo-banner">
            <img id="pcr-promo-img" src="/images/fiverr-banner/fiverr-banner-small.webp" alt="Fiverr">
            <svg class="promo-button-small" fill="white" xmlns="http://www.w3.org/2000/svg" id="arrow-circle-down" viewBox="0 0 24 24" width="512" height="512">
